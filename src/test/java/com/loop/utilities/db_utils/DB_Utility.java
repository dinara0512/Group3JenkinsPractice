package com.loop.utilities.db_utils;
...
public class DB_Utility {
    ...
    // declaring at class level so all methods can access (these instance ref)
    ...
    public static void createConnection(){
        ...
        String url      = "jdbc:oracle:thin:@54.147.227.217:1521:XE" ;
        String username =  "hr";
        String password =  "hr";
